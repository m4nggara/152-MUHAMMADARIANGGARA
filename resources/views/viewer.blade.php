...
<div class="@if(isset($class)) {{ $class }} @else text-white @endif fs-base fw-normal pt-0 mt-0" style="@if(!\App\Helpers\Helper::isPrima($i) && !isset($class)) text-shadow: 2px 1px 2px rgba(0, 0, 0, 0.85); @endif">{{ $jmlstar }} viewers</div>